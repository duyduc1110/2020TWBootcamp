...
'''
def DST_predict(Domain_classifier, YN_classifier, QA_model, chat_history, Threshold = 0.3):
...
if __name__ == "__main__":
    ...
    QA_model = QuestionAnsweringModel('distilbert', 'QA_outputs/')

    chat_history = ["sup! sup!", "Let's have lunch tomorrow.", "Sure.", "where should we meet?", "How about xinyi?", "That's bit far.", "Can we meet at dunhua?", "Sure.",  "what day?", "tomorrow? ", "I can't.", "How about tomorrow?", "That's fine.", "See you there."]
